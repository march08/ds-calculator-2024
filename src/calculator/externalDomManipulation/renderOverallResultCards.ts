...
export const renderOverallResultCards = (result: OverallResult) => {
	...
	const mapped = arrayTotals.slice(0, 2).map(
		...
		<img src=${item.displayValue === 'stack' ? 'https://assets-global.website-files.com/659c190170ce3a9329d76dac/65fbf4bb182a9dfde91d1368_dollars-icon.svg' : 'https://assets-global.website-files.com/659c190170ce3a9329d76dac/65fbf4bbd871a17de019dcc0_employee-icon.svg'} alt="" class="hp-costs_icon">
		<div>
